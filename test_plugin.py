...
# Create Attribute Table for the Floodplain
    ...
    def create_factsheet(self):
        ...
        table.addRow(['Agricultural Prod.', str(self.dlg.comboBox_117.currentText()), self.dlg.lineEdit_280.text(), str(self.dlg.comboBox_114.currentText()), self.dlg.lineEdit_267.text()])
        table.addRow(['Wood', str(self.dlg.comboBox_103.currentText()), self.dlg.lineEdit_270.text(), str(self.dlg.comboBox_108.currentText()), self.dlg.lineEdit_263.text()])
        table.addRow(['Animal Prod.', str(self.dlg.comboBox_96.currentText()), self.dlg.lineEdit_281.text(), str(self.dlg.comboBox_90.currentText()), self.dlg.lineEdit_287.text()])
        table.addRow(['Game Meat', str(self.dlg.comboBox_89.currentText()), self.dlg.lineEdit_268.text(), str(self.dlg.comboBox_102.currentText()), self.dlg.lineEdit_272.text()])
        table.addRow(['Honey', str(self.dlg.comboBox_95.currentText()), self.dlg.lineEdit_275.text(), str(self.dlg.comboBox_94.currentText()), self.dlg.lineEdit_292.text()])
        table.addRow(['Fish', str(self.dlg.comboBox_116.currentText()), self.dlg.lineEdit_279.text(), str(self.dlg.comboBox_99.currentText()), self.dlg.lineEdit_260.text()])
        table.addRow(['Water', str(self.dlg.comboBox_113.currentText()), self.dlg.lineEdit_293.text(), str(self.dlg.comboBox_104.currentText()), self.dlg.lineEdit_271.text()])
        table.addRow(['Local Cli. Reg.', str(self.dlg.comboBox_101.currentText()), self.dlg.lineEdit_285.text(), str(self.dlg.comboBox_93.currentText()), self.dlg.lineEdit_266.text()])
        table.addRow(['Air Purification', str(self.dlg.comboBox_118.currentText()), self.dlg.lineEdit_289.text(), str(self.dlg.comboBox_120.currentText()), self.dlg.lineEdit_283.text()])
        table.addRow(['Low Water Reg.', str(self.dlg.comboBox_91.currentText()), self.dlg.lineEdit_284.text(), str(self.dlg.comboBox_105.currentText()), self.dlg.lineEdit_262.text()])
        table.addRow(['Flood Retention', str(self.dlg.comboBox_111.currentText()), self.dlg.lineEdit_288.text(), str(self.dlg.comboBox_92.currentText()), self.dlg.lineEdit_273.text()])
        table.addRow(['Noise Reg.', str(self.dlg.comboBox_107.currentText()), self.dlg.lineEdit_274.text(), str(self.dlg.comboBox_98.currentText()), self.dlg.lineEdit_265.text()])
        table.addRow(['Provision of Hab.', str(self.dlg.comboBox_110.currentText()), self.dlg.lineEdit_278.text(), str(self.dlg.comboBox_112.currentText()), self.dlg.lineEdit_277.text()])
        table.addRow(['Recreational Act.', str(self.dlg.comboBox_119.currentText()), self.dlg.lineEdit_276.text(), str(self.dlg.comboBox_121.currentText()), self.dlg.lineEdit_269.text()])
        table.addRow(['Water Related Act.', str(self.dlg.comboBox_122.currentText()), self.dlg.lineEdit_290.text(), str(self.dlg.comboBox_109.currentText()), self.dlg.lineEdit_282.text()])
        table.addRow(['Tourism', str(self.dlg.comboBox_115.currentText()), self.dlg.lineEdit_264.text(), str(self.dlg.comboBox_97.currentText()), self.dlg.lineEdit_261.text()])
        table.addRow(['Education', str(self.dlg.comboBox_106.currentText()), self.dlg.lineEdit_291.text(), str(self.dlg.comboBox_100.currentText()), self.dlg.lineEdit_286.text()])
        ...
        table4.addRow([str(self.dlg.lineEdit_232.text()), str(self.dlg.comboBox_64.currentText()), str(self.dlg.comboBox_69.currentText()), str(self.dlg.comboBox_68.currentText())])
        table4.addRow([str(self.dlg.lineEdit_229.text()), str(self.dlg.comboBox_65.currentText()), str(self.dlg.comboBox_58.currentText()), str(self.dlg.comboBox_66.currentText())])
        table4.addRow([str(self.dlg.lineEdit_231.text()), str(self.dlg.comboBox_63.currentText()), str(self.dlg.comboBox_60.currentText()), str(self.dlg.comboBox_62.currentText())])
        table4.addRow([str(self.dlg.lineEdit_230.text()), str(self.dlg.comboBox_61.currentText()), str(self.dlg.comboBox_70.currentText()), str(self.dlg.comboBox_47.currentText())])
        table4.addRow([str(self.dlg.lineEdit_233.text()), str(self.dlg.comboBox_48.currentText()), str(self.dlg.comboBox_59.currentText()), str(self.dlg.comboBox_57.currentText())])
        table4.addRow([str(self.dlg.lineEdit_228.text()), str(self.dlg.comboBox_55.currentText()), str(self.dlg.comboBox_56.currentText()), str(self.dlg.comboBox_67.currentText())])
